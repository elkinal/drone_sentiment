...
#response <- response |>
#  mutate(reason = noquote(lemmatize_words(c(reason)))) 
...
# where 1,2 = oppose ~ 4, 5 = support

#opinion_support = rbind(reason_list[[1]], reason_list[[2]])$reason
#opinion_support
...
lemmatize_words(c("dont", "don't"))
gsub("’","","Because it’s a choice I pick the answer")
